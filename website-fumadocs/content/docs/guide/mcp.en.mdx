...
conversation. tossctl's API surface is **105 operations** (and growing) — exposed as individual
...
Result: always-on context = **exactly 3 tool schemas**. Whether there are 40 operations or 105, the
