...
| `tossctl accumulate list` | Stock accumulation (recurring auto-buy) plans — 📱 mobile-app-only feature |
...
| `tossctl banking status [--full]` | Open-banking status for stock accumulation (holder/account masked by default) |
