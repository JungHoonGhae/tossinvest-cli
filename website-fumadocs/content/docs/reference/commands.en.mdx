...
| `tossctl market research <query> [--effort lite\|standard\|deep\|exhaustive]` | Deep market research with cited sources via You.com (external API, requires `YDC_API_KEY`) |
