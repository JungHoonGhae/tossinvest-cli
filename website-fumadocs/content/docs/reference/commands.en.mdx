...
description: Key CLI commands and complete surface discovery
---
...
All commands except sync work offline. See the [collection contract](/en/docs/guide/history).
...
[session and response scope](/en/docs/guide/hybrid-openapi#response-scope-and-ordering).
...
Visible only after opting into `experimental.paper_trading`. Check server availability and [known limits](/en/docs/reference/support-scope) first.
