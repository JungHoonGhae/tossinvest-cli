...
| `tossctl accumulate funding-status [--full]` | 증권 주식모으기 자금연결·자동주문 등록·거래목적 확인용 MyData 상태(`banking status`는 deprecated alias; 일반 Banking/MyData 아님, 예금주·계좌번호 기본 마스킹, 내부 ID 항상 미출력) |
