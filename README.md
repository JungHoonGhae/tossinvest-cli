...
| **🆕 주식모으기 오픈뱅킹 상태** | `banking status [--full]` (예금주·계좌번호 기본 마스킹) | ❌ | ✅ |
...
tossctl banking status [--full]                  # 주식모으기 오픈뱅킹 연결 상태
